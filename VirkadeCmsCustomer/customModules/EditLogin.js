          ...
          <View style={style.main}>
            ...
            <View style={style.col}>
              ...
              <TextInput
                style={style.input}
                underlineColorAndroid="#9fff80"
                onChangeText={securityQ =>
                  this.setState({securityQ: securityQ})
                }
                value={this.state.securityQ}
              />
            </View>
            <View style={style.col}>
              ...
              <TextInput
                ...
                underlineColorAndroid="#9fff80"
                onChangeText={securityA =>
                  this.setState({securityA: securityA})
                }
                value={this.state.securityA}
              />
