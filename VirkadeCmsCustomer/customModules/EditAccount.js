...
class EditAccount extends Component {
  ...
  addPhoneNumber() {
    ...
    if (user.phoneNumber) {
      this.validateInput(user) &&
        DatabaseAPI.addUserPhone(user, this.updateUser);
    } else {
      this.updateUser();
    }
  }
  ...
  validateInput(data, isAlert = true) {
    ...
    if (
      ...
      age != undefined &&
      age != '' &&
      (!validator.isNumeric(String(age)) || age.length > 3)
    ) {
      ...
      weight != undefined &&
      weight != '' &&
      (!validator.isNumeric(String(weight)) || weight.length > 3)
    ) {
          ...
          <View style={style.main}>
            ...
            <View style={style.col}>
              ...
              <TextInput
                ...
                onChangeText={firstName =>
                  this.updateInput({firstName: firstName})
                }
            ...
            <View style={style.col}>
              ...
              <TextInput
                ...
                onChangeText={lastName =>
                  this.updateInput({lastName: lastName})
                }
            ...
            <View style={style.col}>
              ...
              <TextInput
                ...
                onChangeText={emailAddress =>
                  this.updateInput({emailAddress: emailAddress.trim()})
                }
            ...
            <View style={style.col}>
              ...
              <TextInput
                ...
                value={String(this.state.user.weight)}
              />
            </View>
            <View style={style.col}>
            ...
            <View style={style.col}>
              <Text style={style.checkBox} onPress={this.reCheckBox}>
                {' '}
                {this.state.reServicesLcl} interested in VR real estate
                services?
              </Text>
            </View>
            <View style={style.col}>
              <Text style={style.checkBox} onPress={this.contactCheckBox}>
                {' '}
                {this.state.canContactLcl} can we contact you?{' '}
              </Text>
            </View>
            <View style={style.col} />
            <View>
