        ...
        <View style={style.body}>
          ...
          <View style={style.main}>
            ...
            <View style={style.col}>
              <Text style={style.checkBox} onPress={this.everVrCheckBox}>
                {' '}
                {this.state.playedBefore} ever experienced VR?
              </Text>
            </View>
            <View style={style.col}>
              <Text style={style.checkBox} onPress={this.reCheckBox}>
                {' '}
                {this.state.reServices} interested in VR real estate services?
              </Text>
            </View>
            <View style={style.col}>
              <Text style={style.checkBox} onPress={this.contactCheckBox}>
                {' '}
                {this.state.canContact} can we contact you?{' '}
              </Text>
            </View>
            <View style={style.col} />
            <View>
